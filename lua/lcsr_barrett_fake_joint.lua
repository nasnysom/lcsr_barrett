...
function lcsr_barrett_fake_joint(sim, prefix)
  --[[ defaulat args --]]
  ...
  -- require("load_barrett_fake_joint")
  -- manager = load_barrett_fake_joint(depl, scheme, prefix, sim)
  -- if not manager then
  ...
  --[[ Load controllers --]]
  require("load_controllers_fake_joint")
  load_controllers_fake_joint(depl, scheme, prefix);
